...
class TGAN(torch.nn.Module):
    def __init__(self, num_cls, attn_mode='prod', use_time='time', agg_method='attn', node_dim=None, time_dim=None,
        ...
        self.project_layer = LogReg(self.feat_dim, num_classes=num_cls)
